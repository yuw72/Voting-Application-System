        ...
        private void processMessage(KeyValueList kvList) {
            ...
            switch (messageType) {
                ...
                case SISMessage.REGISER:
                    ...
                    Message message = activityCallbacks.obtainMessage(SISClientListActivity.NEW_COMPONENT_REGISTERED);
                    message.obj = connectionNumber + ":" +sender+":"+ ip + ":" + port;
                    activityCallbacks.sendMessage(message);
                    break;
                case SISMessage.CONNECT:
                    Component cmpttmp = new Component(scope,role,sender);
                    if(Components.componentList.contains(cmpttmp)){
                        ...
                        activityCallbacks.sendMessage(messagetmp);

                        //send a confirm message
                        reply();
                    }else{
                        Message messagetmp = activityCallbacks.obtainMessage(SISClientListActivity.UNREGISTERED_COMPONENT);
                        messagetmp.obj = connectionNumber + ":" +sender+":"+ ip + ":" + port;
                        activityCallbacks.sendMessage(messagetmp);
                    }
                    break;
                ...
                case "Voting":
                    for(Component component:Components.componentList) {
                        ...
                        try {
                            Log.e("wodetian","hahaha");
                            component.encoder.sendMsg(kvList);
                            Log.e("wodetian","wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
